...
# print(f"O quadrado de {x} é {x_quadrado}")
...
# print(f"{celsius} Celsius is {fahr} Fahrenheit")
...
# user_input = input("Escreva uma palavra: ")
...
# x = int(input("Digite um número: "))
# y = int(input("Digite o mesmo número: "))
...
# x = int(input("Digite um número: "))
# y = int(input("Digite um número diferente: "))
